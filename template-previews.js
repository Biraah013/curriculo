...
const templatePreviews = {
    modern: `
        <svg width="300" height="200" viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="80" y="25" fill="white" font-size="12" font-weight="bold">João Silva</text>
    ...
    europass: `
        <svg width="300" height="200" viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="15" y="100" fill="#333" font-size="8">Email: joao@email.com | Telefone: +351 123 456 789</text>
    ...
    classic: `
        <svg width="300" height="200" viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="150" y="25" text-anchor="middle" fill="#333" font-size="14" font-weight="bold">JOÃO SILVA</text>
    ...
    minimalist: `
        <svg width="300" height="200" viewBox="0 0 300 200" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="80" y="30" fill="#333" font-size="16" font-weight="300">João Silva</text>
            <text x="80" y="45" fill="#666" font-size="10">Desenvolvedor | Lisboa | joao@email.com</text>
            ...
            <text x="20" y="110" fill="#666" font-size="10">Tech Company Portugal</text>
